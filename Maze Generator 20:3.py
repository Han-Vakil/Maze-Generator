        ...
        for x in range(width):
            for y in range(height):
                ...
                if pix[x,y] == 0:
                    ...
                    Connections[y][x][5] = 'Done'
                    Connections[y][x][7] = 'N/A'
                    '''Connections[y][x][1] = 'North'
                    Connections[y][x][2] = 'East'
                    Connections[y][x][3] = 'South'
                    Connections[y][x][4] = 'West'''
                    Maze[y][x] = 'Visited'
                    print(Connections[y][x])
        im.save("CADD2.png")
...
create_maze(60,90,6.25,0.25,22.5,4,'Adam.png')
