        ...
        while dirc != "done" and it < 20:
            ...
            if dirc == "done":
                ...
                if it3 < 2000:
                    ...
                    for n in range(4):
                        if (con_lines[5 * (height * (x_coord - 1) + (y_coord - 1)) + n]) != '\n':
                            print(con_lines[(height * (x_coord - 1) + (y_coord - 1)) + n][-6:])
                            x2 = int(con_lines[5 * (height * (x_coord - 1) + (y_coord - 1)) + n][:5])
                            y2 = int(con_lines[5 * (height * (x_coord - 1) + (y_coord - 1)) + n][-6:])
                            if y1 > y2:
                                up = True
                            if y1 < y2:
                                down = True
                ...
                while it4 < 5:
                    ...
                    if direction == 1 and up:
                        y_coord = y_coord - 1
                        current_y = y_coord
                        #dwg.add(dwg.circle(center=((x_coord)*mm,(y_coord)*mm), r=0.15*mm, stroke='red',fill='red', stroke_width=0.05*mm))
                        it4 = 5
