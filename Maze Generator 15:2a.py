            ...
            if dirc == "done":
                ...
                if it3 < 2000:
                    ...
                    while it4 < 5:
                        ...
                        direction = random.randint(1,4)
                        if direction == 1 and up and 'Seconded' not in file_lines[line_in_file + 1] and y_coord != height:
                            current_x = x_coord
                            current_y = y_coord
                            y_coord = y_coord - 1
                            itcount = itcount + 1
                            ...
                            it4 = 5
                        elif direction == 2 and right and it4 == 0 and 'Seconded' not in file_lines[line_in_file + width] and x_coord != width:
                            current_x = x_coord
                            current_y = y_coord
                            x_coord = x_coord + 1
                            itcount = itcount + 1
                            ...
                            it4 = 5
                        elif direction == 3 and down and it4 == 0 and 'Seconded' not in file_lines[line_in_file + 1] and y_coord != 1:
                            current_y = y_coord
                            current_x = x_coord
                            y_coord = y_coord + 1
                            itcount = itcount + 1
                            ...
                            it4 = 5
                        elif direction == 4 and left and it4 == 0 and 'Seconded' not in file_lines[line_in_file - width] and x_coord != 1:
                            current_x = x_coord
                            current_y = y_coord
                            x_coord = x_coord - 1
                            itcount = itcount + 1
                        ...
                        if it4 == 5:
                            ...
                            for line in file_lines:
                                if file_lines.index(line) != line_number:
                                    ...
                                    file.write(str(x_coord) + ',' + str(y_coord) + 'Visited Seconded\n')
