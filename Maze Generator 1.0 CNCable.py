    ...
    while count < (20 * width * height):
        ...
        while dirc != "done" and it < 20:
            ...
            if direction == 1 and not ymax and not upvisit:
                ...
                dwg.add(dwg.line(((current_x)*mm,(current_y)*mm),((x_coord)*mm,(y_coord)*mm),stroke_width=0.01*mm,stroke=svgwrite.rgb(10, 10, 16, '%')))
            ...
            if direction == 2 and not xmax and not rightvisit:
                ...
                x_coord = x_coord + 1
                #dwg.add(dwg.line(((current_x+path_width)*mm,(current_y+path_width)*mm),((x_coord-path_width)*mm,(y_coord+path_width)*mm),stroke_width=0.01*mm,stroke=svgwrite.rgb(10, 10, 16, '%')))
            dwg.add(dwg.line(((current_x)*mm,(current_y)*mm),((x_coord)*mm,(y_coord)*mm),stroke_width=0.01*mm,stroke=svgwrite.rgb(10, 10, 16, '%')))                #dwg.add(dwg.line(((current_x)*mm,(current_y)*mm),((x_coord)*mm,(y_coord)*mm),stroke_width=0.03*mm,stroke=svgwrite.rgb(10, 10, 16, '%')))
