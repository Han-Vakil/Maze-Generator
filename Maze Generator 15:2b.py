...
def create_maze(height,width):
    ...
    while all_connect == False:
        ...
        while dirc != "done" and it < 20:
            ...
            if direction == 1 and not ymax and not upvisit:
                ...
                current_y = y_coord
                y_coord = y_coord + 1
                dwg.add(dwg.line(((current_x+path_width-1)*mm,(current_y+path_width-1)*mm),((x_coord+path_width-1)*mm,(y_coord-path_width-1)*mm),stroke_width=0.01*mm,stroke=svgwrite.rgb(10, 10, 16, '%')))
                dwg.add(dwg.line(((current_x-path_width-1)*mm,(current_y+path_width-1)*mm),((x_coord-path_width-1)*mm,(y_coord-path_width-1)*mm),stroke_width=0.01*mm,stroke=svgwrite.rgb(10, 10, 16, '%')))
            ...
            if direction == 2 and not xmax and not rightvisit:
                ...
                current_x = x_coord
                x_coord = x_coord + 1
                dwg.add(dwg.line(((current_x+path_width-1)*mm,(current_y+path_width)*mm),((x_coord-path_width)*mm,(y_coord+path_width)*mm),stroke_width=0.01*mm,stroke=svgwrite.rgb(10, 10, 16, '%')))
                dwg.add(dwg.line(((current_x+path_width-1)*mm,(current_y-path_width)*mm),((x_coord-path_width)*mm,(y_coord-path_width)*mm),stroke_width=0.01*mm,stroke=svgwrite.rgb(10, 10, 16, '%')))
                #dwg.add(dwg.line(((current_x)*mm,(current_y)*mm),((x_coord)*mm,(y_coord)*mm),stroke_width=0.03*mm,stroke=svgwrite.rgb(10, 10, 16, '%')))
    ...
    for cell in con_lines:
        if con_count % 5 == 0:
            ...
            if conn_test == True:    
                if not down:
                    dwg.add(dwg.line(((x2+path_width-1)*mm,(y2+path_width-1)*mm),((x2-path_width)*mm,(y2+path_width-1)*mm),stroke_width=0.01*mm,stroke=svgwrite.rgb(10, 10, 16, '%')))
                if not up:
                    dwg.add(dwg.line(((x2+path_width-1)*mm,(y2-path_width-1)*mm),((x2-path_width)*mm,(y2-path_width-1)*mm),stroke_width=0.01*mm,stroke=svgwrite.rgb(10, 10, 16, '%')))
                if not right:
                    dwg.add(dwg.line(((x2+path_width-1)*mm,(y2+path_width-1)*mm),((x2+path_width)*mm,(y2-path_width-1)*mm),stroke_width=0.01*mm,stroke=svgwrite.rgb(10, 10, 16, '%')))
