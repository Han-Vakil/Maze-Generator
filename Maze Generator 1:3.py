    ...
    while all_connect == False:
        ...
        if not leftvisit or not rightvisit or not upvisit or not downvisit:    
            ...
            '''for cycle in range(4):
                if filled == False:
                    if Connections[(y_coord - 1)][x_coord - 1][cycle][0] == []:
                        Connections[(y_coord - 1)][x_coord - 1][cycle][0] = current_x
                        print(Connections[(y_coord - 1)][x_coord - 1][cycle][0])
                        Connections[(y_coord - 1)][x_coord - 1][cycle][1] = current_y
                        filled = True'''
        con = open("Maze Connections.txt",'r')
        con_lines = con.readlines()
        con_count = 0
